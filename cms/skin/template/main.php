            ...
            <div class="news_left">
                ...
                <div class="news news4">
                    <ul class="news_area">
						...
						<li class="news4_item">
                            <h2 class="news_tit">
                                <a href="<?=$top[$i]['url']?>"><?=$top[$i]['title']?></a>
                            </h2>
                            <div class="news_text">
						...
						foreach($opinion as $opinion) {
							...
							<li class="opinion_item">
								...
								<div class="opinion_text">
									<a href="/<?=$opinion['serial']?>.html">
										<span class="tc_2"><?=$opinion['description']?></span>
                    ...
                    <div class="academy_slider swiper-container">
                        ...
                        <div class="swiper-wrapper">
							...
							<div class="academy_slider_item swiper-slide">
                                <a href="/<?=$data['description']?>.html" class="academy_slider_area">
                                    ...
                                    <span class="academy_slider_text">
                                        ...
                                        <span class="academy_slider_list">
                                            <span data-tit="<?=$data['subject_1']?>"><?=$data['content_1']?></span>
											<span data-tit="<?=$data['subject_2']?>"><?=$data['content_2']?></span>
                                        </span>
                                    </span>
                                </a>
                            </div>
