            ...
            <div class="row wp_40 mb_30 ai_stretch">
                    ...
                    <div class="editor_writer" >
                        ...
                        <div class="ew_m_btn_box">
                            ...
                            <div class="ew_m_btn">
                                ...
                                <span><i class="iconFt_link1"></i></span>
                            </button>
                            </div>
                            <div class="ew_m_btn">
                ...
                <div class="col_9">
                                ...
                                <div class="col_24">
                                    ...
                                    <div class="row ai_c mt_10">
                                        ...
                                        <div class="sel_box col_7 offset_1">
                                            <select name="" id="" class="sel fm_full placeholder __customUi">
                    ...
                    <div class="row wp_20 pt_40">
                        ...
                        <div class="col_24">
                            <button type="button" class="btn_lg btn_c2 btn_full"><span>리뷰 입력 완료</span></button>
                        </div>
                    </div>
                </div>
                <!--기사 정보}-->
