...
<script type="text/javascript">
	...
	function js_view(no) {
		...
		param = param.replace('?', '&');
		href = '/category/write_news_kind?seq=' + no + param;
		location.href = href;
		return;
	}
			...
			<div class="table_box horizontal">
				<table class="t_center">
					<colgroup>
						...
						<col data-col-width="45" />
						<col data-col-width="110" />
						<col data-col-width="600"/>
					...
					<?php
						...
						for ($j = 0 ; $j < count($rs['data']); $j++) {
							...
							<tr>
								...
								<td><div class="t_left ellip_1 fs_14"><a href="javascript:;" onclick="js_view('<?=$data['id']?>')"><?=$str_category?></a></div></td>
								<td>
