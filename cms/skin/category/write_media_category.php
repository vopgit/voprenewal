...
<script type="text/javascript">
	...
	function js_save() {
		...
		if(frm.media_category_name.value==""){
			alert('미디어(매체)명을 입력해 주세요.');
			frm.media_category_name.focus();
			return;
		}
		...
		if(confirm(_msg)){
			$('#frm').attr('action', '/category/dml_MediaCategory');
			$('#frm').submit();
		}
	...
	function js_del(){
		if(confirm('삭제하시겠습니까?')){
			...
			frm.target = "";
			frm.action = "/category/dml_MediaCategory";
			frm.submit();
		}
	}
                        ...
                        <div class="area_con_box">
                            ...
                            <div class="row ai_stretch wp_30 wp_st_2">
								...
								<div class="col_24">
                                    <div class="row wp_30">
                                        <div class="col_24">
                                            <label for="">미디어(매체)명</label>
                                            <input type="text" name="media_category_name" maxlength="30" value="<?=$rs["name"]?>" class="inp inp_sm fm_full mt_10 mb_20" >
                                        </div>
                                    </div>
                                </div>
