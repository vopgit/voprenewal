...
<!-- <form name="frm" id="frm" action="/pop/published_contents"> -->
    <div class="popup_box">
...
<script>
	...
	function js_search(){
		...
		location.href = '/pop/published_contents?relate_id=' + $('#relate_id').val() + s_serial_qry + s_title_qry;
	}
	...
	function js_go_page(nPage){
		...
		location.href = '/pop/published_contents?relate_id=' + $('#relate_id').val() + '&nPage=' + nPage + s_serial_qry + s_title_qry;
	}
	...
	function js_set_data(){
		...
		parent.js_set_relate_data(JSON.stringify(data));
		$('.pop_close').click();
