...
<script>
	...
	function js_search(){
		...
		location.href = '/pop/relate?relate_id=' + $('#relate_id').val() + s_serial_qry + s_title_qry;
	}
	...
	function js_go_page(nPage){
		...
		location.href = '/pop/relate?relate_id=' + $('#relate_id').val() + '&nPage=' + nPage + s_serial_qry + s_title_qry;
	}
