...
<div class="contain">
    ...
    <div class="wrap">
        <h3 class="mb_20">칼럼 관리</h3>

            <div class="area_box mb_30">
                <div class="area_tit_box">
                    <div class="area_tit t_right">
                        <button type="button" class="btn btn_c2 search"  data-url="popup_ty2" onclick="act_popup(this)"><span>칼럼명 관리</span></button>
                    </div>
                </div>
                ...
                <div class="area_con_box ptbl_0">
                    <div class="table_box horizontal ty_tab act_hov t_center">
                        ...
                        <form name="frm_s" id="frm_s" method="get" action="/publish/column">
						<div class="row plr_30 ptb_25 search_box">
                            <div class="col_5 pr_10">
                                <input type="text" name="s_serial" id="s_serial" class="inp fm_full" placeholder="시리얼 넘버" value="<?=$s_serial?>" maxlength="12">
                            </div>
                            <div class="col_5 pr_10">
                                <select name="s_grp" id="s_grp" class="sel sel_md fm_full">
                                    <option value="">컬럼 그룹</option>
...
$(document).ready(function() {
	...
	$('.btn_modify').click(function(){
		var id = $(this).closest('tr').data('id');
		if(id != ''){
			location.href = "/publish/input?contents_id=" + id + "&refer=column<?=str_replace('?', '&', $param['query'])?>";
		}		
	});
});
