...
<div class="contain">
    ...
    <div class="wrap">
        <form name="frm" id="frm" method="post" onsubmit="return false;" enctype="multipart/form-data">
			...
			<input type="hidden" name="fromUrl" value="<?=urlencode('/publish/'.$refer.$param['query'])?>">
                            ...
                            <div class="row wp_30">
                                ...
                                <div class="col_24">
                                    ...
                                    <div class="scroll_box mt_10">
										...
										<input type="hidden" name="old_osmu" id="old_osmu" value="<?=$str_old_osmu?>">
