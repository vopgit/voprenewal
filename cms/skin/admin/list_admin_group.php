    ...
    <div class="wrap">
		...
		<form  name="frm" id="frm" method="post">
			...
			<div class="row ai_c mb_20">
				...
				<div class="table_box horizontal mt_20">
					<table class="t_center">
						...
						<thead >
							<tr>
								...
								<td class="t_left">
									<input type="text" class="txt inp" style="width:75%" name="group_name" required/>
									<input type="text" class="txt" name="text_mode " style="width:75px;border:0px;margin-left:10px;outline: none;"  value="[ 등록모드 ]" readonly="">
								</td>
							</tr>
						</thead>
					</table>
