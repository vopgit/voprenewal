...
function js_delete(){
	if(confirm("탈퇴 하시겠습니까?")){
		document.frm.mode.value = "del_me";
		$('#frm').submit();
	}	
}
...
<div class="wrap">
    ...
    <form name="frm" id="frm" method="post" action="/member/dml" autocomplete="off" enctype="multipart/form-data">
	<input type="hidden" name="mode" value="mod_me">
	<input type="hidden" name="rtnUrl" value="/member/me">
        <div class="row">
            <div class="col_15"> 
                <div class="info_box">

					<div class="info_wrap row td_thumb">
						<div class="photo_thumb_box ty_circle">
							<div class="thumb">
								<?php if($rs['filepath'] != ''){ ?>
									<img src="<?=getListPhoto(_IMAGE_ROOT,  ltrim($rs['filepath'], '/'), '')?>" alt="">
								<?php }else{?>
						...
						<div class="row in_multy_radio jc_se mt_30 dif_sel">
							<?php if(($rs['filepath'] != '')&&($rs['filepath'] != 'NULL')){ ?>
							<div class="col_24">
								<select name="flag" class="sel fm_full mt_10" onchange="js_fileView(this)">
						...
						<div class="file_box jc_c pt_30" <?=(($rs['filepath'] != '')&&($rs['filepath'] != 'NULL'))?"style='display:none'":"" ?>>
							<div class="file_con">
            ...
            <div class="col_9 pl_40"> 
                <div class="row info_right">
                    <div class="info_box mb_40">
                        ...
                        <div class="row row wp_10">
                            <div class="col_6 plr_10">
                                <a href="/contents/list?type=article&status=tempstored">
                            ...
                            <div class="col_6 plr_10">
                                <a href="/contents/list?type=article&status=standby">
                            ...
                            <div class="col_6 plr_10">
                                <a href="/contents/list?type=article&status=published">
                            ...
                            <div class="col_6 plr_10">
                                <a href="/contents/list?type=article&status=deleted">
                    ...
                    <div class="info_box">
                        ...
                        <div class="row row wp_10">
                            <div class="col_6 plr_10">
                                <a href="/contents/list?type=image&status=published">
                                    <div class="t_center stabox stabox_c3">
                                            <p class="sta_c3 ">발행중</p>
                                            <p class="fs_24 fw_600"><?=number_format($myphoto['image']['published'])?></p>
                                        </div>
                                    </div>
                                </a>
                            <div class="col_6 plr_10">
                                <a href="/contents/list?type=image&status=reserved">
                                    <div class="t_center stabox stabox_c5">
                                            <p class="sta_c5 ">보류중</p>
                                            <p class="fs_24 fw_600"><?=number_format($myphoto['image']['reserved1'] + $myphoto['image']['reserved2'])?></p>
                                        </div>
                                    </div>
                                </a>
                            
                            <div class="col_6 plr_10">
                                <a href="/contents/list?type=image&status=deleted">
                                    <div class="t_center stabox stabox_c4">
                                            <p >삭제됨</p>
                                            <p class="fs_24 fw_600"><?=number_format($myphoto['image']['deleted'])?></p>
                                        </div>
                                    </div>
                                </a>
                        </div>
    ...
    <div class=" mt_30 row jc_sb">
        ...
        <a href="javascript:;" onclick="js_delete()" class="btn_lg btn_c2 btn_line_c14"> 계정 탈퇴</a>
    </div>
</div>
