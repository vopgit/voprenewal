...
(function (window, $, undefined) {
	...
	$.html5imageupload = function html5imageupload(options, element) {
		...
		//buttons
		this.button				= {}
		this.button.edit		= '<div class="btn_img btn-info btn-edit"><i class="glyphicon glyphicon-pencil"></i></div>'
		this.button.saving		= '<div class="btn_img btn-warning saving">' + (this.options.saveLabel || 'Saving...') + ' <i class="glyphicon glyphicon-time"></i></div>';
		this.button.zoomin		= '<div class="btn_img btn-default btn-zoom-in"><i class="glyphicon glyphicon-resize-full"></i></div>';
		this.button.zoomout		= '<div class="btn_img btn-default btn-zoom-out"><i class="glyphicon glyphicon-resize-small"></i></div>';
		this.button.zoomreset	= '<div class="btn_img btn-default btn-zoom-reset"><i class="glyphicon glyphicon-fullscreen"></i></div>';
		this.button.cancel		= '<div class="btn_img btn-danger btn-cancel"><i class="glyphicon glyphicon-remove"></i></div>';
		this.button.done		= '<div class="btn_img btn-success btn-ok"><i class="glyphicon glyphicon-ok"></i></div>';
		this.button.del			= '<div class="btn_img btn-danger btn-del"><i class="glyphicon glyphicon-trash"></i></div>';
