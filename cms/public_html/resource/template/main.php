    ...
    <div class="con main"><!--con main-->
                ...
                <div class="opinion">
                    ...
                    <ul class="opinion_area">
						...
						foreach($opinion as $opinion) {
							...
							$writer_name = "";
							$writer_role = $writer_name = $opinion['company'];

							if($opinion['contributor'] != ""){
								$writer_name = $opinion['contributor'];
							}else{
								if($opinion['name'] != ""){
									$writer_name = $opinion['name'];
								}else{
							...
							<li class="opinion_item">
								<div class="opinion_img">
									<a href="/<?=$opinion['serial']?>.html">
										...
										<?php if($opinion['writer_filepath'] != ''){ ?>
											<img src="<?=$opinion['photo_opinion_writer']?>" alt="<?=$opinion['author']?>" onerror="noImage(this);">
										<?php }else{?>
											<img src="<?=$opinion['photo_opinion_writer']?>" alt="<?=$opinion['author']?>" onerror="noImage(this);">
										<?php }?>
                    ...
                    <div class="academy_slider swiper-container">
                        ...
                        <div class="swiper-wrapper">
							...
							<div class="academy_slider_item swiper-slide">
                                <a href="/<?=$data['serial']?>.html" class="academy_slider_area">
        ...
        <section class="media">
            <div class="wrap_1180">
                ...
                <div class="row ai_stretch wp_40 wp_md_20 media_items photo">
					...
					<div class="col_12 col_sm_24 media_left">
                        <div class="media_area">
                            <div class="media_img <?=($photo[$i]['icon'] == 'Y') ? 'move' : ''?>">
                ...
                <div class="main_arcad_1 t_center">
					<div class="ad-big-container"><!-- PC 모바일 광고 -->
						<!-- /11438317/main_970x250  /11438317/mobile_300x250(list)  -->
						 <div id='div-gpt-ad-1617252958310-0'>
							 <script>
                            ...
                            <div class="youtube_slider swiper-container swiper-container-initialized swiper-container-horizontal">
                                ...
                                <div class="swiper-wrapper" style="transform: translate3d(0px, 0px, 0px);">
									...
									<div class="youtube_slider_item swiper-slide swiper-slide-active" style="width: 206.8px;">
                                        <a href="<?=$data['youtube']?>" target="_blank" class="youtube_slider_area">
                            ...
                            <div class="notice">
                                ...
                                <div class="notice_txt">
									<?php if($alim['data'][0]['id'] != ''){ ?>
										<a href="/alim/<?=$alim['data'][0]['serial']?>"><span class="fw_400">[<?=$alim['data'][0]['category']?>]</span> <?=$alim['data'][0]['contents']?></a></div>
									<?php }else{ ?>
										알림글이 없습니다.
									<?php } ?>
