        ...
        <div class="view_top">
            <div class="wrap_980">
                ...
                <div class="view_top_cate2">
					...
					<!-- <span class="view_top_cate2_txt2"><a href="#">그룹명</a></span> -->
                </div>
                ...
                <div class="view_con_left">
                    ...
                    <div class="vcr_box bg_wh ">
						<h2 class="vcr_tit bor_bt_111">
							<span>기사 원소스 보기</span>
							<?php if($osmu_cnt > 0){ ?>
								<span class="vcr_count"><?=($osmu_cnt > 999) ? '999+' : $osmu_cnt;?></span>
							<?php } ?>
						</h2>
						...
						<ul class="vcr_list dst_1">
							<?php foreach($rs['relate'] as $rdata) { ?>
								<li><a href="<?=$rdata['serial']?>.html">
									<?php if($rdata['thumb'] != ''){ ?>
									<span class="img_box">
										<span class="img_con"><img src="<?=rtrim(_IMAGE_URL,'/')."/".ltrim($rdata['thumb'], '/')?>" alt="사진" onerror="noDataImage(this)"></span>
									</span>
									<?php } ?>
                        ...
                        <div class="cheer_con">
                            <div class="row ai_c">
                                <div class="col_12">
                                    ...
                                    <div class="cheer_img">
                                        <div class="img_con">
                                            <img src="<?=$Writer_photo?>" alt="<?=$support_name?> 사진" onerror="noDataImage(this)">
                                        </div>
                                    </div>
                                </div>
                                <div class="col_12">
